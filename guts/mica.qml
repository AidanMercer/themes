...
// guts: manga-page chrome for mica — the Brand-red spine along the left edge,
// an ink halftone screen in the corner, a heavy ink frame, and a burst of
// speedlines slashing across the page on every directory change.
Item {
    id: chrome
    ...
    // ── speedlines: ink rays flash from the right edge when the folder turns ──
