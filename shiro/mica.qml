...
// shiro: the poem-page treatment for mica — a blush wash at the top of the
// paper and an enso that inks itself in bottom-right, re-brushing each time you
// turn to a new folder. Calm by contract: the only motion is the draw-in.
Item {
    id: chrome
    ...
    readonly property Component backdrop: Component {
        Item {
            // washi fibers in the sheet; the top blush breathes while the window
            // is awake, still as dried ink otherwise
            ShaderEffect {
                anchors.fill: parent
            ...
            Canvas {
                ...
                // the enso re-inks itself each time you turn to a new folder
                Connections {
                    target: chrome.host
