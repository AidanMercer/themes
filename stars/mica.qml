...
// in the upper panes, the machine's amber shelf-light warming the bottom-left
// corner, and a shooting star that crosses the sky each time you open a folder.
Item {
    id: chrome
    ...
    // ── a shooting star crosses the sky each time you sail into a folder ──
